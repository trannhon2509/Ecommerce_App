                        ...
                        <div className="row gy-4">
                                ...
                                <div className="card widget-card border-light shadow-sm">
                                    ...
                                    <div className="card-body">
                                        <div className="text-center mb-3">
                                            <img src="/img/logo.png" width={100} className="img-fluid rounded-circle" alt="Luna John" />
                                        </div>
                            ...
                            <div className="col-12">
                                <div className="card widget-card border-light shadow-sm">
                                    ...
                                    <div className="card-body">
                                        <a href="#!" className="d-inline-block bg-dark link-light lh-1 p-2 rounded">
                            ...
                            <div className="card-body p-4">
                                ...
                                <div className="tab-content pt-4" id="profileTabContent">
                                    <div className="tab-pane fade show active" id="overview-tab-pane" role="tabpanel" aria-labelledby="overview-tab" tabIndex={0}>
                                        ...
                                        <p className="lead mb-3">Ethan Leo is a seasoned and results-driven Project Manager who
                                            brings experience and expertise to project management. With a proven track
                                            record of successfully delivering complex projects on time and within budget,
                                            Ethan Leo is the go-to professional for organizations seeking efficient and
                                            effective project leadership.</p>
